...
for (const service of [
 {
    ...
    updateTest: {oldCreds: 'wtfprotocol@gmail.com', newCreds: 'nanaknihal@gmail.com'} //currently, just using the owner's address -- perhaps should also test for other addresses 
},
//  {name: 'orcid', params: googleParams},
//  {name: 'twitter', params: googleParams},
//  {name: 'github', params: googleParams},
]){

    let {name, params, lookupTest, updateTest} = service;
